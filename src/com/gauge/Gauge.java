...
public final class Gauge extends View {
	...
	private int scaleCenterValue = 0; // The one in the top center (12 o'clock),
										// This corresponds with the (180 Degree's)
	...
	private String lowerTitle = "Km/Hr";
	private String upperTitle = "Speed";
	private String unitTitle = "Speed";

	// Fixed values.
	private static final float scalePosition = 0.10f; // The distance from the
														// rim to the scale
	private static final float valuePosition = 0.285f; // The distance from the
														// rim to the ranges
	private static final float rangePosition = 0.122f; // The distance from the
														// rim to the ranges
	private static final float titlePosition = 0.145f; // The Distance from the
														// rim to the titles
	private static final float unitPosition = 0.300f; // The distance from the
														// rim to the unit
	private static final float rimSize = 0.02f;

	private final float degreesPerNotch = 360.0f / totalNotches;
	private static final int centerDegrees = -90; // the one in the top center
													// (12 o'clock), this
													// corresponds with -90
													// degrees
	...
	private void initDrawingTools() {
		...
		rangeRect = new RectF();
		rangeRect.set(faceRect.left + rangePosition, faceRect.top
				+ rangePosition, faceRect.right - rangePosition,
				faceRect.bottom - rangePosition);

		valueRect = new RectF();
		valueRect.set(faceRect.left + valuePosition, faceRect.top
				+ valuePosition, faceRect.right - valuePosition,
				faceRect.bottom - valuePosition);
	...
	private int notchToValue(int notch) {
		int rawValue = ((notch < totalNotches / 2) ? notch
	...
	private float valueToAngle(float value) {
		// scaleCenterValue represents an angle of 180 Degree's.
